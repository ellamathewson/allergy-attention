...
var renderList = function renderList() {
  ...
  return React.createElement("div", null, React.createElement("h3", null, " Friends "), React.createElement("ul", null, listItems));
};

var updateNewFriend = function updateNewFriend(e) {
  newFriendState.newFriend = e.target.value;
  ReactDOM.render(React.createElement(FriendsContainer, {
...
var FriendsContainer = function FriendsContainer(props) {
  return React.createElement("div", null, React.createElement("h3", null, " Name: ", props.name, " "), React.createElement(AddFriend, {
